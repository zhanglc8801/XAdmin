...
layui.config({
    base: '/layuiadmin/' //layui自定义layui组件目录
    ...
    var html = "<link rel=\"stylesheet\" href=\"/layuiadmin/modules/cropper.css\">\n" +
        ...
        "            <div class=\"img-preview\" style=\"width:200px;height:200px;overflow:hidden;cursor:pointer;\" onclick=\"SelImage(this)\">\n" +
        "            </div><br />" +
        "            <div class=\"img-preview\" style=\"width:100px;height:100px;overflow:hidden;cursor:pointer;\" onclick=\"SelImage(this)\">\n" +
        "            </div><br />" +
        "            <div class=\"img-preview\" style=\"width:50px;height:50px;overflow:hidden;cursor:pointer;\" onclick=\"SelImage(this)\">\n" +
        "            </div>\n" +
        "        </div>\n" +
        "    </div>\n" +
        "    <div class=\"layui-row layui-col-space15\">\n" +
        ...
        "                    <button type=\"button\" class=\"layui-btn\" cropper-event=\"zoom\" title=\"放大图片\">放大</button>\n" +
        "                    <button type=\"button\" class=\"layui-btn\" cropper-event=\"narrow\" title=\"缩小图片\">缩小</button>\n" +
        "                    <button type=\"button\" class=\"layui-btn layui-icon layui-icon-refresh\" cropper-event=\"reset\" title=\"重置图片\">重置</button>\n" +
        "                </div>\n" +
        "            </div>\n" +
        "        </div>\n" +
        "        <div class=\"layui-col-xs3\">\n" +
